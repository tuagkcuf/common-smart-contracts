...
// - have more than amount tokens in the his balance
...
// import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.0.0/contracts/token/ERC20/IERC20.sol"; - updated to a new location
...
contract TokenSwap {
    ...
    function swap() public {
        ...
        require(
            token2.allowance(owner2, address(this)) >= amount1,
